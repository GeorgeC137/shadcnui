...
import { Home, Inbox, Calendar, Search, Settings, User2, ChevronUp, Plus, ProjectorIcon, ChevronDown } from "lucide-react"
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton asChild>
                            <Link href='/'>
                                <Image src="https://picsum.photos/200" alt="logo" width={20} height={20} className="rounded-full" />
                                <span>Jijow Stores</span>
                            </Link>
                        </SidebarMenuButton>
                    </SidebarMenuItem>
                </SidebarMenu>
                    ...
                    <SidebarMenuItem>
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <SidebarMenuButton>
                                    <User2 /> George Omollo <ChevronUp className="ml-auto" />
                                </SidebarMenuButton>
                            </DropdownMenuTrigger>
